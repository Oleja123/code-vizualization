...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = DoWhileStmt.class,   name = "DoWhileStmt"),
    ...
    @JsonSubTypes.Type(value = GotoStmt.class,      name = "GotoStmt"),
    @JsonSubTypes.Type(value = LabelStmt.class,     name = "LabelStmt"),
})
