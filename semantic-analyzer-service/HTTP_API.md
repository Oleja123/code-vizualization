...
Сервис семантического анализа предоставляет HTTP REST API для валидации кода на C с проверкой семантики и опциональной проверкой компиляции через OneCompiler API.

**Основные возможности:**
- Парсинг C кода в AST
- Семантическая валидация (типы, операторы)
- Опциональная проверка компиляции
